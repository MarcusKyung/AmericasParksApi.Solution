...
namespace AmericasParksApi.Migrations
{
    ...
    [Migration("20230609213903_AddORandCAStateParkData")]
    partial class AddORandCAStateParkData
    {
            ...
            modelBuilder.Entity("AmericasParksApi.Models.Park", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ParkId = 67,
                            Area = "2,256 acres",
                            DateEstablished = "1931",
                            Description = "Protects part of the largest lagoon system in the United States, including Big Lagoon, Stone Lagoon, and Freshwater Lagoon.",
                            Location = "California",
                        ...
                        new
                        {
                            ParkId = 68,
                            Area = "2,309 acres",
                            DateEstablished = "1932",
                            Description = "Preserves rocky coast and rare habitats like mima mounds and Monterey pine forest, as well as a 5,850-year-old Native American archaeological site.",
                            Location = "California",
                        ...
                        new
                        {
                            ...
                            Area = "24,693 acres",
                            DateEstablished = "1933",
                            Description = "Preserves an expansive tract of forests and meadows above 5,000 feet (1,500 m) in the Laguna Mountains, on the former Rancho Cuyamaca.",
                            Location = "California",
